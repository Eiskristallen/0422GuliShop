<template>
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul
          ...
          :key="trademark.tmId"
        >
          <li @click="searchBybrand(trademark)">
            {{ trademark.tmName }}
          </li>
          <!-- <li>TCL</li>
          <li>长虹（CHANGHONG）</li>
    ...
    <div class="type-wrap" v-for="attr of attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="attrValue of attr.attrValueList" :key="attrValue.index">
            <a href="javascript:;" @click="searchByAttrVal(attr, attrValue)">{{
              attrValue
            }}</a>
          </li>
          <!-- <li>
...
export default {
  ...
  methods: {
    ...
    searchBybrand(trademark) {
      this.$emit('searchByBrand', trademark);
    },
    //点击属性搜索
    //传Attr过去,里面包含了Attr ID,Value
    searchByAttrVal(attr, attrValue) {
      this.$emit('searchByAttr', attr, attrValue);
    },
  },
  computed: {
